...
import ForeCastFinder from "../assets/images/landing_svgs/ForeCastFinder.jpg";
  ...
  return (
    <div id="main">
      ...
      <div className="app-name">
        <img src={ForeCastFinder} alt="Logo" width="20%" height="20%" />
      </div>
      <div className="main-grid">
        ...
        <div className="credits">
          by&nbsp;
          <a
            href="https://github.com/Sneha-526"
            target="_blank"
            rel="noopener noreferrer"
          >
            <strong>Sneha Pandit</strong>
          </a>
        </div>
      </div>
    </div> // main
